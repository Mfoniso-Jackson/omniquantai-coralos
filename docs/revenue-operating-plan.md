...
5. Workspace collaboration: authenticated team workspaces, reviewer permissions, and shared export packets.

Recently shipped:

- Session History / Saved Memo Workspace with saved sessions, memo previews, proof links, and data
  provenance hooks.
- API-backed workspace review controls for analyst notes, reviewer assignment, review status, export-ready state, and export history.
