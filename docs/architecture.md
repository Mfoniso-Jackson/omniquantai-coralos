...
flowchart LR
  ...
  Buyer --> Want["WANT service=omniquant arg=nvda-6m-exposure"]
  ...
  Escrow --> Delivery["DELIVERED financial intelligence"]
  Delivery --> Release["Arbiter RELEASED payment"]
...
| Seller service | `coral-agents/seller-agent/src/service.ts` | delivers the OmniQuantAI structured research report |
...
| Dashboard | `examples/marketplace/web` | visualizes bids, settlement, and delivered intelligence |
