...
- Added local review status, analyst notes, and export-ready controls so saved memos can move through
  a lightweight investment committee workflow.
...
- Persist workspace notes and review state through the API once user accounts/workspaces exist.
